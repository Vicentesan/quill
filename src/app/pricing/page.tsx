...
const Page = () => {
  ...
  return(
    <>
    <MaxWidthWrapper className='mb-8 mt-24 text-center m-w-5xl'>
      <div className='mx-auto mb-10 sm:max-w-lg'>
        <h1 className='text-6xl font-bold sm:text-7xl'>Pricing</h1>
        <p className='mt-5 text-gray-600 sm:text-lg'>Whether you&apos;re just trying ou our service or need more, we&apos;ve got you covered</p>
      </div>
        ...
        <TooltipProvider>
          {pricingItems.map(({plan, tagline, quota, features}) => {
            ...
            return <div key={plan} className={cn('relative rounded-2xl bg-white shadow-lg', {
              ...
              {plan === 'Pro' && (
                <div className='absolute -top-5 left-0 right-0 mx-auto w-32 rounded-full bg-gradient-to-r from-blue-600 to-cyan-300 px-3 py-2 text-sm font-medium text-white'>
                  Upgrade now
                </div>
              )}
