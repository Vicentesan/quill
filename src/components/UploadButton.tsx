...
const UploadDropzone = ({isSubscribed}: {isSubscribed: boolean}) => {
  ...
  return (
    ...
    <DropZone noClick={true} multiple={false} onDrop={async (acceptedFile) => {
      setIsUploading(true)
            ...
            <label htmlFor="dropzone-file" className='flex flex-col items-center justify-center w-full h-full rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100'>
              <div className='flex flex-col items-center justify-center pt-5 pb-6'>
                ...
                <p className='mb-2 text-sm text-zinc-700'>
                  <span className='font-semibold'>Click to upload</span> or drag and drop you file
                </p>
              ...
              {acceptedFiles && acceptedFiles[0] ? (
                <div className='max-w-xs bg-white flex items-center rounded-md overflow-hidden outline outline-[1px] outline-zinc-200 divide-x divide-zinc-200'>
                  ...
                  <div className='px-3 py-2 w-full text-sml truncate'>
